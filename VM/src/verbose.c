...
{
	if (chariot->ope == 12)
		ft_printf("%d (%d)", (short)war->param[i],
...
void		verbose(t_war *war, t_chariot *chariot)
{
	...
	if (war->verbose[2] == 1)
	{
		ft_printf("P %4d | %s ", chariot->index + 1,
